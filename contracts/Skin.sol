...
contract Skin is ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, Delegatable {
    using SafeMathUpgradeable for uint256;
    ...
    modifier accessControl {
        require(msg.sender == owner() || msg.sender == minter, "Can't access to this function");
        _;
    }

    function initialize() public initializer{
        __ERC721_init("SKIN", "SKIN");
        __Delegatable_init();
        _maxSupply = 10 ** 18;
    }
    ...
    function getTokenIdsByAddress(address _addr) public view returns(uint256[] memory){
    ...
    function mint(string memory _tokenURI, uint256 _tokenMeta, address _owner) external accessControl{
        require((totalSupply()) < _maxSupply, "Exceeds maximum supply");
    ...
    function setMaxSupply (uint256 _supply) public onlyOwner{
        _setMaxSupply(_supply);
    }

    function resetMaxSupplyToDefault () public onlyOwner {
        _setMaxSupply(10 ** 18);
    }
}